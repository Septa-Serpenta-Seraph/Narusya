# ComfyUI Character Portrait Workflow

Narusya-specific workflow for generating dark fantasy/gothic character portraits via SDXL.
...
Save as `narusya_workflow_API.json`:
...
3. Route through LoRA node: update sampler `model` input
